...
const SongViews = (() => {
  ...
  const CATEGORIES = ['lyrics', 'notes', 'chords', 'score'];
  ...
  function attach(page, data = null) {
    ...
    page.doc.append(lyrics, chords, scoreEmpty);
    renderChords(page);
  ...
  return { init, attach, set, refresh, serialize, restore, deepest, closePicker };
})();
